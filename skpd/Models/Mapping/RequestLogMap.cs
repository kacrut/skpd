...
namespace skpd.Models.Mapping
{
    public class RequestLogMap : EntityTypeConfiguration<RequestLog>
    {
        public RequestLogMap()
        {
            ...
            this.ToTable("RequestLog", "skpd");
            this.Property(t => t.RequestLogID).HasColumnName("RequestLogID");
            ...
            this.Property(t => t.RequestLogDate).HasColumnName("RequestLogDate");

...
[assembly: WebActivator.PreApplicationStartMethod(typeof(skpd.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(skpd.App_Start.SimpleMembershipMvc3), "Initialize")]

namespace skpd.App_Start
{
	public static class SimpleMembershipMvc3
	{
		...
		public static void Initialize()
		{
            ...
            WebSecurity.InitializeDatabaseConnection(connectionStringName: "ESKAPEDEContext", userTableName: "User", userIdColumn: "ID", userNameColumn: "Username", autoCreateTables: true);
